...
pub fn do_gen_src() -> anyhow::Result<()> {
    ...
    update_file::update_file(&sss, "comps/cmp_clap/src/curl.cmd.help.rs.txt")?;
    //
    let sss = do_gen_src_match(&vec_optstr)?;
    update_file::update_file(&sss, "comps/cmp_clap/src/curl.cmd.match.rs.txt")?;
    //
    let sss = do_gen_src_lex(&vec_optstr)?;
    update_file::update_file(&sss, "comps/cmp_clap/src/curl.cmd.lex.rs.txt")?;
    //
    Ok(())
}
